  ...
  return (
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
      ...
      <input
        type="text"
        id="text"
        placeholder="ex: Exercícios, dormir bem, tomar água, etc..."
        className="p-4 roundel-lg mt-3 bg-zinc-800 text-white placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-violet-900 focus:ring-offset-2 focus:ring-offset-zinc-900"
        autoFocus
        value={title}
